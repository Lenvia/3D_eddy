...
function init(){
    ...
    //创建相机对象
    camera = new THREE.PerspectiveCamera( 60, renderWidth / renderHeight, 1, 20000 );
...
function loadEddyModel(){
    var object_loader = new OBJLoader();
    object_loader.load('./resources/isEddy_color_6.obj', function(object) {
        ...
        meshObj.geometry.translate(-250, -250, 0);
