...
joblib.dump(xdata, 'xdata_vort.pkl')
joblib.dump(ydata, 'ydata_vort.pkl')
joblib.dump(zdata, 'zdata_vort.pkl')
joblib.dump(value, 'value_vort.pkl')

xdata = joblib.load('xdata_vort.pkl')
ydata = joblib.load('ydata_vort.pkl')
zdata = joblib.load('zdata_vort.pkl')
value = joblib.load('value_vort.pkl')
